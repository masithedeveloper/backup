...
public abstract class Hilt_PersonSearchFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PersonSearchFragment() {
    super();
  }

  Hilt_PersonSearchFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PersonSearchFragment_GeneratedInjector) this.generatedComponent()).injectPersonSearchFragment(UnsafeCasts.<PersonSearchFragment>unsafeCast(this));
    }
  }
