...
public abstract class Hilt_CreatePersonFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreatePersonFragment() {
    super();
  }

  Hilt_CreatePersonFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreatePersonFragment_GeneratedInjector) this.generatedComponent()).injectCreatePersonFragment(UnsafeCasts.<CreatePersonFragment>unsafeCast(this));
    }
  }
