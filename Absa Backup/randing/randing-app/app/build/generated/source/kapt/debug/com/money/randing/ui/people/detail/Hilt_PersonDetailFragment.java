...
public abstract class Hilt_PersonDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PersonDetailFragment() {
    super();
  }

  Hilt_PersonDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PersonDetailFragment_GeneratedInjector) this.generatedComponent()).injectPersonDetailFragment(UnsafeCasts.<PersonDetailFragment>unsafeCast(this));
    }
  }
