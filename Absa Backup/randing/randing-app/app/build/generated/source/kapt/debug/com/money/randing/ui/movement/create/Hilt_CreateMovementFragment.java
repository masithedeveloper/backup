...
public abstract class Hilt_CreateMovementFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreateMovementFragment() {
    super();
  }

  Hilt_CreateMovementFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateMovementFragment_GeneratedInjector) this.generatedComponent()).injectCreateMovementFragment(UnsafeCasts.<CreateMovementFragment>unsafeCast(this));
    }
  }
