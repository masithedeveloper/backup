...
public abstract class Hilt_PeopleFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PeopleFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PeopleFragment_GeneratedInjector) this.generatedComponent()).injectPeopleFragment(UnsafeCasts.<PeopleFragment>unsafeCast(this));
    }
  }
