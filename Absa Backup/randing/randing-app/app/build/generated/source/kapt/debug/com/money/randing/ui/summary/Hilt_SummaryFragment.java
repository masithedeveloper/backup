...
public abstract class Hilt_SummaryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SummaryFragment() {
    super();
  }

  Hilt_SummaryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SummaryFragment_GeneratedInjector) this.generatedComponent()).injectSummaryFragment(UnsafeCasts.<SummaryFragment>unsafeCast(this));
    }
  }
