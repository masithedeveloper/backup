...
import com.barclays.absa.banking.framework.api.request.params.OpCodeParams.OP0330_ADD_NEW_BENEFICIARY_RESULT
import com.barclays.absa.banking.framework.api.request.params.RequestParams
import com.barclays.absa.banking.framework.api.request.params.TransactionParams.Transaction

class AddNewBeneficiaryResultRequest<T>(referenceNumber: String, hasImage: String,
                                        responseListener: ExtendedResponseListener<T>)
    : ExtendedRequest<T>(responseListener) {

    init {
        params = RequestParams.Builder().put(OP0330_ADD_NEW_BENEFICIARY_RESULT)
