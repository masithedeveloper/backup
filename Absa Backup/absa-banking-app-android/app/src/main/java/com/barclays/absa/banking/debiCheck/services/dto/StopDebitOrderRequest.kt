...
class StopDebitOrderRequest<T>(debitOrderDataModel: DebitOrderDataModel, responseListener: ExtendedResponseListener<T>) : ExtendedRequest<T>(responseListener) {
    init {
        params = RequestParams.Builder()
                .put(DebitOrderService.OP2113_STOP_DEBIT_ORDER)
                ...
                .put(DebitOrderService.STOP_PAYMENT_TYPE, "debit")
                ...
                .build()
        mockResponseFile = DebitOrderMockFactory.stopDebitOrder()
        printRequest()
    }
