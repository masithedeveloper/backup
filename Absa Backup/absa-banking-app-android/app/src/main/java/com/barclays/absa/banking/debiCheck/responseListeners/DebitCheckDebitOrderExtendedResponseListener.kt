...
class DebitCheckDebitOrderExtendedResponseListener(private var viewModel: DebiCheckViewModel) : ExtendedResponseListener<MandateResponse>() {
    override fun onSuccess(successResponse: MandateResponse) {
        viewModel.pendingMandateResponse.value = successResponse
    }
}