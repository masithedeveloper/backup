...
class CreditCardTemporaryLockParametersRequest<T>(responseListener: ExtendedResponseListener<T>)
    ...
    override fun getResponseClass(): Class<T> = ResponseListener::class.java as Class<T>
