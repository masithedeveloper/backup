...
class WesternUnionCountriesListRequest<T>(extendedResponseListener: ExtendedResponseListener<T>) : ExtendedRequest<T>(extendedResponseListener) {
    ...
    init {
        params = RequestParams.Builder()
                ...
                .build()
        mockResponseFile = "international_payments/op0883_get_all_western_union_countries_list.json"
        printRequest()
    }
