...
class BuyNewFundResponseListener(private val buyUnitTrustViewModel: BuyUnitTrustViewModel) : ExtendedResponseListener<BuyMoreFundsResponse>() {
    override fun onSuccess(successResponse: BuyMoreFundsResponse) {
        buyUnitTrustViewModel.buyMoreFundsResponseLiveData.value = successResponse
    }
}