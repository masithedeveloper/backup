...
class SwiftLinkedAndUnlinkedAccountsResponseListener(private val viewModel: SwiftTransactionsViewModel) : ExtendedResponseListener<LinkedAndUnlinkedAccounts>() {

    override fun onSuccess(successResponse: LinkedAndUnlinkedAccounts) {
        viewModel.swiftLinkedAndUnlinkedAccounts.value = successResponse
    }
}
