...
class BeneficiaryTransactionDetailsRequest<T>(beneficiaryId: String, beneficiaryType: String,
    ...
    override fun getResponseClass(): Class<T> = BeneficiaryTransactionDetails::class.java as Class<T>
