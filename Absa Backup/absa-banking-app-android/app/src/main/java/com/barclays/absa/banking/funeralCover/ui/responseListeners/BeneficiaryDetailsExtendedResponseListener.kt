...
class BeneficiaryDetailsExtendedResponseListener internal constructor(private val insurancePolicyClaimViewModel: InsurancePolicyClaimViewModel) : ExtendedResponseListener<BeneficiaryDetailObject>() {

    override fun onSuccess(successResponse: BeneficiaryDetailObject) {
        insurancePolicyClaimViewModel.beneficiaryDetailsLiveData.value = successResponse
    }
