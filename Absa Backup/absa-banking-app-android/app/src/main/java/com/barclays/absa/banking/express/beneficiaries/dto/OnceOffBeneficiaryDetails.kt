...
class OnceOffBeneficiaryDetails : BaseModel {
    var realTimePaymentAllowed: Boolean = false
    ...
    var lastMaintenanceDateAndTime: Date = Date()
    var accountType: BeneficiaryAccountType = BeneficiaryAccountType.NONE
    var verifiedPaymentIndicator: Boolean = false
