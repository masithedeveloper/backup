...
class CashSendExistingBeneficiaryConfirmationRequest<T>(beneficiaryDetails: BeneficiaryDetailObject,
    ...
    init {
        params = super.buildRequestParams()
                .put(Transaction.SERVICE_BEN_NAME_CASHSEND, beneficiaryDetails.beneficiaryName)
                .put(Transaction.SERVICE_BEN_ID_CASHSEND, beneficiaryDetails.beneficiaryId)
                .put(Transaction.SERVICE_BEN_ACCOUNT_NUMBER_CASHSEND, beneficiaryDetails.actNo)
                .put(Transaction.SERVICE_CELL_NO_CASHSEND, beneficiaryDetails.actNo)
                .build()
