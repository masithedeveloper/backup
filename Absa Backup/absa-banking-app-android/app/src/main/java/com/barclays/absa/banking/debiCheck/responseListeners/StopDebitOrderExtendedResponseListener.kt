...
class StopDebitOrderExtendedResponseListener(var viewModel: DebitOrderViewModel) : ExtendedResponseListener<TransactionResponse>() {
    override fun onSuccess(successResponse: TransactionResponse) {
        viewModel.stopDebitOrderResponse.value = successResponse
    }
}