...
public class SimpleSectionedGridAdapter extends BaseAdapter {
    ...
    final SparseArray<Section> mSections = new SparseArray<>();
    ...
    public void setGridView(GridView gridView) {
        ...
        setRequestedColumnWidth(gridView);
        requestedHorizontalSpacing = gridView.getHorizontalSpacing();
    }

    private void setRequestedColumnWidth(GridView gridView) {
    ...
    private int getHeaderSize() {
        ...
        if (mWidth != mGridView.getWidth()) {
            ...
            setRequestedColumnWidth(mGridView);
