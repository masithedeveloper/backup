...
package com.barclays.absa.banking.recognition.services.dto.models

data class BranchRecognitionConfirmation(var qrCode: String? = "",
                                         var functionCode: String? = "",
                                         var digitalIdentity: String? = "",
                                         var productType: String? = "",
                                         var productCode: String? = "",
                                         var productSubCode: String? = "",
