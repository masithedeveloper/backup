...
class AccountHistoryClearedExtendedResponseListener : ExtendedResponseListener<AccountDetail>() {

    private val homeCacheService: IHomeCacheService = getServiceInterface()

    override fun onSuccess(accountDetail: AccountDetail) = homeCacheService.setHomeLoanAccountHistoryCleared(accountDetail)
