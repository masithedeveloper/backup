...
class PersonalInformationExtendedResponseListener(var presenter: OverdraftSetupPresenter) : ExtendedResponseListener<PersonalInformationResponse?>() {
    override fun onSuccess(successResponse: PersonalInformationResponse?) {
        presenter.marketingMethodsReceived(successResponse)
    }
}