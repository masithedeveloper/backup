...
class DebiCheckApprovedFragment : BaseFragment(R.layout.debi_check_fragment), ItemSelectionInterface {
    ...
    private var accountList: List<AccountObject> = emptyList()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.adapterInterface = object : DebiCheckAdapterInterface {
            override fun onDebitOrderSelected(mandate: DebiCheckMandateDetail) {
                ...
                hostActivity.tagDebiCheckEvent("ApprovedMandates_ApprovedMandateItemClicked")
                view.findNavController().navigate(R.id.action_DebiCheckApprovedFragment_to_DebiCheckMandateDetailsFragment)
            }
        ...
        accountSelectorView.apply {
            setTitleText(R.string.debicheck_select_account_approved)
            ...
            setItemSelectionInterface(this@DebiCheckApprovedFragment)
        }
        mandateListTitleView.text = getString(R.string.debicheck_approved_mandates)
        attachDataObserver()
    ...
    override fun onItemClicked(index: Int) {
        if (index != accountListItemSelectedIndex) {
            viewModel.fetchMandates(accountList[index].accountNumber, "Active", "")
        }
