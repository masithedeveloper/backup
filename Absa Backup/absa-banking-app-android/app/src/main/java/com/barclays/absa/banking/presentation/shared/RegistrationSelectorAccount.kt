...
class RegistrationSelectorAccount(private val account: RegisterAccountListObject) : SelectorInterface {

    override val displayValue: String?
        get() = "${account.accountDescription} (${account.accessBillingAccountNumber})"

    override val displayValueLine2: String?
        get() = account.accessBillingAccountNumber
}