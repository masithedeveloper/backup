...
internal interface UnitTrustAccountView : BaseView {
    fun displayUnitTrustAccount(successResponse: UnitTrustAccountsWrapper)
    fun displaySomethingWentWrongScreen()
}