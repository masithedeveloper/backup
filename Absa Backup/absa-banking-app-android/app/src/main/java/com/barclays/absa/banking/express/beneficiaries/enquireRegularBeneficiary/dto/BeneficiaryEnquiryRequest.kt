...
package com.barclays.absa.banking.express.beneficiaries.enquireRegularBeneficiary.dto

import com.barclays.absa.banking.express.shared.dto.InstructionType

class BeneficiaryEnquiryRequest {
    var beneficiaryNumber: Int = 0
    var uniqueEFTNumber: String = ""
    var tieBreaker: String = ""
    var cifKey: String = ""
    var beneficiaryStatus: String = "CURRENT"
