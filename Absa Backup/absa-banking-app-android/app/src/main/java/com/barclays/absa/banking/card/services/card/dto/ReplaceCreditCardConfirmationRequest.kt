...
import com.barclays.absa.banking.card.services.card.dto.CreditCardService.OP0871_CREDIT_CARD_REPLACEMENT_CONFIRMATION
...
class ReplaceCreditCardConfirmationRequest<T>(replacementConfirmationResponseListener: ExtendedResponseListener<T>,
                                              cardReplacementConfirmation: CreditCardReplacementConfirmation)
    : ExtendedRequest<T>(replacementConfirmationResponseListener) {
    ...
    init {
        ...
        val requestParamsBuilder = RequestParams.Builder()
                .put(OP0871_CREDIT_CARD_REPLACEMENT_CONFIRMATION)
        ...
        mockResponseFile = "card/op0871_credit_card_replacement_confirmation.json"
        printRequest()
    }
