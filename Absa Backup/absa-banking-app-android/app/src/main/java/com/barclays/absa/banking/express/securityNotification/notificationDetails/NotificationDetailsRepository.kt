...
package com.barclays.absa.banking.express.securityNotification.notificationDetails
...
class NotificationDetailsRepository : Repository() {
    ...
    override val operation: String = "Request2FANotificationDetails"
    override var mockResponseFile: String = "express/securityNotification/2fa_notification_details_response.json"
    ...
    suspend fun fetchNotificationDetails(securityNotificationDetails: SecurityNotificationDetails): NotificationDetailsResponse? {
