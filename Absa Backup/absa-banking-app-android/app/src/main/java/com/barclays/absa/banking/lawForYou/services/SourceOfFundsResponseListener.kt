...
class SourceOfFundsResponseListener(private val viewModel: LawForYouPolicyDetailsViewModel): ExtendedResponseListener<LookupResult>() {
    override fun onSuccess(successResponse: LookupResult) {
        viewModel.sourceOfFundsListMutableLiveData.value = successResponse.items
    }
}