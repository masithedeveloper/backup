...
public interface CreditCardReplacementView extends BaseView {
    void showCreditCardReplacementReasons(CreditCardReplacementReasonsList creditCardReplacementList);

    void navigateToOrderNewCardScreen();
}
