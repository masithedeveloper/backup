...
interface BranchRecognitionRepository {

    fun getRecognitionMenuInfo(): LiveData<BranchRecognitionResponse>
    fun uploadBranchFeedback(branchFeedback: BranchRecognitionConfirmation)
}