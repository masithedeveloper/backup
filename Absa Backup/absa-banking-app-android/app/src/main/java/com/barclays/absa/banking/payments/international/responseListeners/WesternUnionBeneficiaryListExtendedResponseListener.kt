...
class WesternUnionBeneficiaryListExtendedResponseListener(private val presenter: InternationalPaymentsPaymentHubPresenter) : ExtendedResponseListener<WesternUnionBeneficiaryListObject?>() {
    override fun onRequestStarted() {

    }

    override fun onSuccess(successResponse: WesternUnionBeneficiaryListObject?) {
