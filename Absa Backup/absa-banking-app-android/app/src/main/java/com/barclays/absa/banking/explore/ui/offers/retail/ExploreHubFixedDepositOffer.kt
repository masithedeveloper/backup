...
class ExploreHubFixedDepositOffer(exploreHubInterface: NewExploreHubInterface, val onOfferClicked: (() -> Unit)? = null) : ExploreHubBaseOffer() {
    ...
    override var featureToggle: Int = featureSwitchingToggles.fixedDepositApplication
    override var buildConfigToggle: Boolean = true
    override var additionalToggleChecks: Boolean = !(context as BaseActivity).shouldBlockUser()
