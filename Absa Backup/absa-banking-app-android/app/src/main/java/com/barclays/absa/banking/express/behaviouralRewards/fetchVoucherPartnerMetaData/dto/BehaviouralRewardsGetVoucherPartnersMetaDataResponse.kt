...
class BehaviouralRewardsGetVoucherPartnersMetaDataResponse : BaseResponse() {
    var voucherPartnerMetaData: ArrayList<VoucherPartnerMetaDatum> = arrayListOf()
}

class VoucherPartnerMetaDatum : BaseModel {
