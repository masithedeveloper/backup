...
class WesternUnionCitiesListRequest<T>(countryCode: String, stateName: String, extendedResponseListener: ExtendedResponseListener<T>)
    ...
    init {
        params = RequestParams.Builder()
                ...
                .put(WesternUnionParameters.STATE_NAME, stateName.toUpperCase())
                .build()
        mockResponseFile = "international_payments/op0883_get_all_western_union_cities_list.json"
        printRequest()
    }
