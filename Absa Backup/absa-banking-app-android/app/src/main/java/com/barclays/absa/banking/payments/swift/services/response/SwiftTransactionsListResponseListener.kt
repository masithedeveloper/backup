...
class SwiftTransactionsListResponseListener(private val viewModel: SwiftTransactionsViewModel) : ExtendedResponseListener<SwiftTransactionsListResponse>() {

    override fun onSuccess(successResponse: SwiftTransactionsListResponse) {
        viewModel.swiftTransactionsListMutableLiveData.value = successResponse
    }
}