...
class ChangePolicyBeneficiaryRequest<T>(policyInfo: PolicyInfo, policyBeneficiaryInfo: PolicyBeneficiaryInfo, callType: CallType,
    ...
    init {
        ...
        requestBuilder.put(OpCodeParams.OPCODE_KEY, OP0910_CHANGE_BENEFICIARY)
        ...
        mockResponseFile = ManageBeneficiaryMockFactory.changeBeneficiary(callType)
    ...
    companion object {
        const val OP0910_CHANGE_BENEFICIARY = "OP0910"
    }
}