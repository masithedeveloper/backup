...
class OccupationResponseListener(private val viewModel: LawForYouPolicyDetailsViewModel): ExtendedResponseListener<LookupResult>() {
    override fun onSuccess(successResponse: LookupResult) {
        viewModel.occupationListMutableLiveData.value = successResponse.items
    }
}