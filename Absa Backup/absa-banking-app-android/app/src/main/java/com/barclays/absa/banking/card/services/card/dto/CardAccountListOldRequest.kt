...
class CardAccountListOldRequest<T>(responseListener: ExtendedResponseListener<T>) : ExtendedRequest<T>(responseListener) {
    ...
    override fun getResponseClass(): Class<T> = CardAccountListOld::class.java as Class<T>
