...
class MoneyMarketConvertAccountExtendedResponseListener(private val moneyMarketViewModel: MoneyMarketViewModel) : ExtendedResponseListener<SureCheckResponse>() {
    override fun onSuccess(successResponse: SureCheckResponse) {
        moneyMarketViewModel.moneyMarketConvertAccountLiveData.value = successResponse
    }
}