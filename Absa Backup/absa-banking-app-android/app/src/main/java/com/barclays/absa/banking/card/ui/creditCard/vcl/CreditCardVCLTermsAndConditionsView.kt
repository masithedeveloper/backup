...
interface CreditCardVCLTermsAndConditionsView : BaseView {
    fun navigateToIncomeAndExpenseScreen()
    fun navigateToIncomeAndExpenseScreen(bureauData: CreditCardBureauData?)
    fun updateCreditCardGadgetData(successResponse: CreditCardOverdraft?)
}
