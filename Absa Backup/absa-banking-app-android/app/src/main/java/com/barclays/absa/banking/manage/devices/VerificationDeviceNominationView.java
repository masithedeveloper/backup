...
interface VerificationDeviceNominationView extends BaseView {
    void showSurecheckConfirmation();
    void goToSureCheckCountDownScreen(TransactionVerificationType verificationType);
}
