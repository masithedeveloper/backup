...
class CashSendPlusBeneficiaryListResponseListener(private var cashSendPlusViewModel: CashSendPlusViewModel) : ExtendedResponseListener<BeneficiaryListObject>() {
    override fun onSuccess(successResponse: BeneficiaryListObject) {
        cashSendPlusViewModel.cashSendPlusBeneficiaryListResponse.value = successResponse
    }
}