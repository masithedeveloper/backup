...
class EditExergyBeneficiaryRequest<T>(policyInfo: PolicyInfo, policyBeneficiaryInfo: PolicyBeneficiaryInfo, extendedResponseListener: ExtendedResponseListener<T>) : ExtendedRequest<T>(extendedResponseListener) {

    init {
        val idType = policyBeneficiaryInfo.idType?.second ?: ""

        params = RequestParams.Builder(ManageBeneficiaryService.OP2175_EDIT_EXERGY_BENEFICIARY)
        ...
        mockResponseFile = "insurance/op2175_edit_exergy_beneficiary.json"
        printRequest()
    }
