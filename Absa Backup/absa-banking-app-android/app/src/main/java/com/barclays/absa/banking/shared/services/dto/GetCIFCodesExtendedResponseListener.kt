...
class GetCIFCodesExtendedResponseListener(private var viewModel: SharedViewModel) : ExtendedResponseListener<LookupResult>() {
    override fun onSuccess(successResponse: LookupResult) {
        viewModel.codesLiveData.value = successResponse
    }
}