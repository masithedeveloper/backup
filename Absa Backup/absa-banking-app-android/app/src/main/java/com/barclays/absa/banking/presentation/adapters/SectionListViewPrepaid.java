 ...
 */
public class SectionListViewPrepaid extends ListView implements OnScrollListener {

    private View transparentView;

    public SectionListViewPrepaid(final Context context, final AttributeSet attrs, final int defStyle) {
        super(context, attrs, defStyle);
        commonInitialisation();
    }

    public SectionListViewPrepaid(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        commonInitialisation();
    }

    public SectionListViewPrepaid(final Context context) {
        super(context);
        commonInitialisation();
    }
    ...
    public void setAdapter(final ListAdapter adapter) {
        ...
        transparentView = ((SectionListAdapterAirtime) adapter).getTransparentSectionView();
        if (parent instanceof FrameLayout) {
