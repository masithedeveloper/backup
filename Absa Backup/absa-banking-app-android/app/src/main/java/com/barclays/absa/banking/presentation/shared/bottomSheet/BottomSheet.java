...
public class BottomSheet extends Dialog implements DialogInterface {
    ...
    BottomSheet(Context context, int theme) {
        ...
        TypedArray a = getContext()
                .obtainStyledAttributes(null, R.styleable.BottomSheet, R.attr.bottomSheetStyles, 0);
        try {
    ...
    private void init(final Context context) {
        ...
        if (builder.title != null) {
            ...
            title.setTextColor(ContextCompat.getColor(context, R.color.bottom_sheet_title));
        }
        ...
        if (getMenu().size() > limit) {
            ...
            ActionMenuItem item = new ActionMenuItem(context, 0, R.id.bs_more, limit - 1, moreText);
            item.setIcon(more);
            menuItem.add(item);
            actions = menuItem;
    ...
    private void showFullItems() {
        ...
        icon.setOnClickListener(v -> showShortItems());
        setListLayout();
    }
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Activity context) {
            ...
            TypedArray ta = context.getTheme().obtainStyledAttributes(new int[]{R.attr.bottomSheetStyles});
            try {
        ...
        public Builder sheet(int id, @DrawableRes int iconRes, @StringRes int textRes) {
            ActionMenuItem item = new ActionMenuItem(context, 0, id, 0, context.getText(textRes));
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public Builder sheet(int id, int icon, @NonNull CharSequence text) {
            ActionMenuItem item = new ActionMenuItem(context, 0, id, 0, text);
            item.setIcon(icon);
            menu.add(item);
            return this;
        }
