...
public interface MultiplePaymentBeneficiaryDetailsView extends BaseView {

    void navigateToSelectedBeneficiary(PayBeneficiaryPaymentConfirmationObject validatePaymentObject);

    void setError();

    void showErrorToast(String viewTag);
