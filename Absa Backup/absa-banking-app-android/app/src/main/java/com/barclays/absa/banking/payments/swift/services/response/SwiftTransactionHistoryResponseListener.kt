...
class SwiftTransactionHistoryResponseListener(private val viewModel: SwiftTransactionsViewModel) : ExtendedResponseListener<SwiftTransactionHistoryResponse>() {

    override fun onSuccess(successResponse: SwiftTransactionHistoryResponse) {
        viewModel.swiftTransactionHistoryMutableLiveData.value = successResponse
    }
}