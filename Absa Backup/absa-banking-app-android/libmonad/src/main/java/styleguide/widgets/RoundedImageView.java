...
public class RoundedImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mMaskDrawable = a.getDrawable(R.styleable.RoundedImageView_attribute_mask_drawable);
        if (mMaskDrawable != null) {
            mMaskDrawable.setCallback(this);
        }

        mBorderDrawable = a.getDrawable(R.styleable.RoundedImageView_attribute_border_drawable);
        if (mBorderDrawable != null) {
            mBorderDrawable.setCallback(this);
        }

        mDesaturateOnPress = a.getBoolean(R.styleable.RoundedImageView_attribute_desaturate_on_press, mDesaturateOnPress);
